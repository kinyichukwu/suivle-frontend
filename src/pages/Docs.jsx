    ...
    <div className="bg-sui-bg min-h-screen overflow-hidden relative">
      ...
      <section className="relative w-full text-white flex flex-col justify-center items-center pt-24 md:pt-32 lg:pt-36 pb-16 px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          ...
          <a
            ...
            className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-lg font-semibold hover:bg-white/15 transition-all text-center flex items-center justify-center gap-2"
          >
      ...
      <section className="relative w-full px-4 pb-20">
        <div className="max-w-4xl mx-auto">
          ...
          {error && (
            <div className="flex items-center justify-center py-32">
              <div className="text-center max-w-lg bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8">
          ...
          {!loading && !error && markdown && (
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 md:p-12 shadow-2xl">
